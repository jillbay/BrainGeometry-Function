...
basis_connectome = eigenmodes.eig_vec; 
eigenmodes = load(sprintf('data/examples/connectome_density-matched_eigenmodes-lh_200.mat')); 
basis_connectome_density_matched = eigenmodes.eig_vec; basis_EDR = load(sprintf('%s/basis_connectome_EDR_midthickness-%s_evec_%i.mat', data_results_folder, hemisphere, num_modes));
%%
eigenmodes = load(sprintf('data/examples/synthetic_EDRconnectome_eigenmodes-lh_200.mat')); 
basis_EDR = eigenmodes.eig_vec; 
...
% eigenmodes
load(sprintf('%s/task_reconstruction_corr_modes=%i_%s_%s.mat', data_results_folder, num_modes, parc_name, hemisphere), 'task_recon_corr_geometric'); 
...
% eigenmodes
load(sprintf('%s/resting_reconstruction_corr_modes=%i_%s_%s.mat', data_results_folder, num_modes, parc_name, hemisphere), 'resting_recon_corr_geometric.mat'); 
%%
resting_recon_corr_geometric = resting_reconstruction_corr_modes200_Glasser360_lh.resting_recon_corr_geometric;
...
data_Figure1 = data_Figure1.Figure1;
