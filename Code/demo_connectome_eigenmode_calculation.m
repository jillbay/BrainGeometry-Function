...
% medial wall first
connectome = load('data/empirical/S255_high-resolution_group_average_connectome_cortex_nomedial-lh.mat'); 
...
% threshold = 0.001; % preserve 1% of connections; change accordingly
